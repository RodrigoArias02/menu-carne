...
const ContentModalCard = () => {
  return (
    <div className="content-modal-card">
        <div className="container-img">

            <img src="https://as2.ftcdn.net/jpg/00/80/57/39/1000_F_80573907_41jXLIrB4bDISKPwFnyjlVPmLr3YtWZo.jpg" alt="Producto" />
        </div>
        <h2>Hamburguesa de carne vacuna</h2>
        <h3>4 pack - premium blend</h3>
        <p className='description-card'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta eius ab vero officiis harum cupiditate consequatur debitis. Fugit dolor veritatis quia, saepe, optio quis laudantium vero dolore corrupti ratione repellendus?</p>
        <ProductDetails />
        <span className="label">
          ...
          <p>Ahorras <b>$360</b> llevando 2kg</p>
        </span>
        <Quantity initial={1} min={1} max={10} onChange={(value) => console.log(value)} />
        <span className="label">
